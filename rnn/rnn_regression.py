...
class LSTMRNN(object):
	...
	def add_input_layer(self,):
		l_in_x = tf.reshape(self.xs,[-1,self.input_size],name='2_2D')	#(batch*n_step, in_size)    3D-->2D
		...
		self.l_in_y = tf.reshape(l_in_y,[-1,self.n_steps,self.cell_size],name = '2_3D')	# 2D-->3D
